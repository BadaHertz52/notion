...
const Export = ({
  ...
  const onClickExportBtn = () => {
    const includeSubpagesSlider = document.getElementById(
    ...
    if (includeSubpagesSlider !== null) {
      ...
      const includeSubPage: boolean =
        includeSubpagesSlider.classList.contains("on");
      ...
      function convertSubPageFrameIntoHtml(
        ...
        const subPageHtmls = subPageFrames.map(
      ...
      <div className="inner">
        <div className="selects">
          <div className="select">
            <div className="select_label">Export format</div>
          ...
          <div className="select">
            <div className="select_label">Include content</div>
            <div className="select_form">
              <button onClick={(event) => openOptions(event)}>
                {content}
                <MdKeyboardArrowDown />
          ...
          <div className="select switch">
            <div className="select_label">Include subpages</div>
            <button onClick={onClickSwitchBtn} className="switchBtn">
        ...
        <div className="btns">
          ...
          <button onClick={onClickExportBtn}>Export</button>
        </div>
      </div>
    </div>
  );
