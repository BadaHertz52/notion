  ...
  const changeToListType = (editedBlock: Block, parentBlockType: BlockType) => {
    if (
      ...
      if (editedBlock.parentBlocksId !== null) {
        ...
        if (parentBlock.type.includes("Array")) {
          ...
          if (index === 0) {
            ...
            if (index === subBlocksId.length - 1) {
              ...
              const newAfterArrayBlock: Block = {
                ...newBlock,
                id: `${page.id}_${editTime}(1)`,
                subBlocksId: afterSubBlocksId,
              };
              blocks.splice(indexOfBlocks + 2, 0, newAfterArrayBlock);
              blocksId.splice(indexOfBlocks + 2, 0, newAfterArrayBlock.id);
              if (parentBlock.firstBlock) {
                const indexAsFirst = firstBlocksId.indexOf(parentBlock.id);
                firstBlocksId.splice(
                  indexAsFirst + 2,
                  0,
                  newAfterArrayBlock.id
                );
              }
            }
          }
  ...
  const changeType = (blockType: BlockType) => {
    ...
    if (block.type !== blockType) {
      const editedBlock: Block = {
        ...
        editTime: JSON.stringify(Date.now()),
        type:
          blockType === "bulletListArray"
            ? "bulletList"
            : blockType === "numberListArray"
            ? "numberList"
            : blockType,
      ...
      switch (blockType) {
        case "page":
          ...
          break;
        case "numberListArray":
          changeToListType(editedBlock, "numberListArray");
          break;
        case "bulletListArray":
          changeToListType(editedBlock, "bulletListArray");
          break;
        default:
          block.type === "page"
    ...
    <div id="commandBlock" style={style}>
      <div id="commandBlock_inner">
        <div className="command basic_blocks">
          <header className="command_header">BASIC BLOCKS</header>
          <div className="command_btns type">
            ...
            <button
              className="command_btn on"
              onClick={() => changeType("bulletListArray")}
              name="bullet list"
            >
              <div className="command_btn_inner">
                <div className="command_btn_left">
            ...
            <button
              className="command_btn on"
              onClick={() => changeType("numberListArray")}
              name="number list"
            >
              <div className="command_btn_inner">
                <div className="command_btn_left">
        ...
        <div className="command media_blocks">
          <header className="command_header">MEDIA</header>
          <div className="command_btns type">
            <button
              className="command_btn on"
      ...
      <div className="noResult" id="commandBlock_noResult">
        No results
      </div>
    </div>
  );
