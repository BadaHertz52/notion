  ...
  if (contentEditableHtml !== null && contentEditableHtml !== undefined) {
    ...
    children.forEach((c: Node) => {
      ...
      if (c.nodeType === 1) {
        ...
        contentsArray.push(element.outerHTML);
      }
    });
    const newBlockContents = contentsArray.join("");
    newBlock = {
      ...block,
...
const BlockStyler = ({
  ...
  const prepareForChange = () => {
    ...
    const contentEditableHtml = document.getElementById(`${block.id}_contents`)
  ...
  return (
    <>
      ...
      >
        <div className="inner">
          <button className="typeBtn btn" onClick={onClickTypeBtn}>
          ...
          <button
            ...
            onClick={() => {
              !openMobileBlockMenu && setOpenLink(!openLink);
            }}
          ...
          <div className="styles">
            <button
              ...
              onClick={() => {
                !openMobileBlockMenu && onClickFontStyleBtn(bold);
              }}
              onTouchStart={prepareForChange}
            ...
            <button
              ...
              onClick={() => {
                !openMobileBlockMenu && onClickFontStyleBtn(italic);
              }}
              onTouchStart={prepareForChange}
            ...
            <button
              ...
              onClick={() => {
                !openMobileBlockMenu && onClickFontStyleBtn(underline);
              }}
              onTouchStart={prepareForChange}
            ...
            <button
              ...
              onClick={() => {
                !openMobileBlockMenu && onClickFontStyleBtn(lineThrough);
              }}
              onTouchStart={prepareForChange}
          ...
          <button
            ...
            onClick={() => {
              !openMobileBlockMenu && onClickColorBtn();
            }}
            onTouchStart={prepareForChange}
            onTouchEnd={() => {
          ...
          <button
            ...
            onClick={() => {
              !openMobileBlockMenu && onClickMenuBtn();
            }}
            onTouchStart={prepareForChange}
            onTouchEnd={() => {
      ...
      {openColor && (
        <div id="blockStylerColor" style={menuStyle}>
          <ColorMenu
            page={page}
            block={selection ? selection.block : block}
            editBlock={editBlock}
