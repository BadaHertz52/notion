...
const basicPageCover =
  "https://raw.githubusercontent.com/BadaHertz52/notion/master/src/assests/img/artificial-turf-g6e884a1d4_1920.jpg";
/**
...
const Frame = ({
    ...
    if (moveTargetBlock !== null && moveBlock.current) {
      ...
      if (moveTargetBlockHtml !== null && editor !== null) {
        moveTargetBlockHtml.setAttribute(
          "style",
          `position:absolute; top:${y + editor.scrollTop + 5}px; left:${
            x + 5
          }px`
        );
      }
  ...
  const updateBlock = () => {
    ...
    if (item !== null) {
      ...
      const condition =
        ...
        cursorElement !== null &&
        cursorElement.parentElement?.id === `${targetBlock.id}_contents`;
      if (!condition) {
  ...
  const setItemForMobileMenu = (SELECTION: Selection) => {
    ...
    if (
      ...
      if (blockContentElement !== null) {
        const blockId = blockContentElement.id.replace("_contents", "");
  ...
  inner?.addEventListener("click", (event: globalThis.MouseEvent) => {
    ...
    document.getElementById("popupMenu") &&
      closePopup(event, document.getElementById("popupMenu"));
  ...
  return (
    <div
      ...
      style={{
        overflowY:
          openMobileMenu || (isMobile() && popup.popup) ? "hidden" : "scroll",
      }}
    >
      <div
      ...
      >
        <div className="page">
            ...
            <div className="pageHeader_notCover">
              ...
              <div className="deco">
                {decoOpen && (
                  <div>
                    {page.header.icon == null && (
                      <button className="decoIcon" onClick={addRandomIcon}>
                        <BsFillEmojiSmileFill />
                        <span>Add Icon</span>
                      </button>
                    )}
                    {page.header.cover == null && (
                      <button className="decoCover" onClick={onClickAddCover}>
                        <MdInsertPhoto />
                        <span>Add Cover</span>
                      </button>
                    )}
              ...
              <div className="pageComment" style={pageCommentStyle}>
                {page.header.comments !== null ? (
          ...
          <div className="pageContent" onClick={onClickPageContentBottom}>
            {!newPageFrame ? (
              <div
      ...
      {command.boolean && command.targetBlock !== null && (
        <div id="block_commandBlock" style={commandBlockPosition}>
          <CommandBlock
      ...
      {popup.popup && (
        <div id="popupMenu" style={popupStyle}>
