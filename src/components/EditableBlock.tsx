              ...
              >
                <div className="mainBlock_block">
                  {block.type === "todo" && (
                    ...
                    >
                      <GrCheckbox className="blockBtnSvg" />
                    </button>
                  )}
                  ...
                  {block.type === "toggle" && (
                    ...
                    >
                      <MdPlayArrow className="blockBtnSvg" />
                    </button>
                  )}
                  {block.type === "page" && (
