    ...
    <>
      <div id="templates" onClick={(event) => onClickTemplate(event)}>
        <div className="inner">
          ...
          <div id="templates_side" className={expand ? "off" : ""}>
            <button className="useTemplateBtn" onClick={onClickUseBtn}>
              Use this template
            </button>
      ...
      {openEditAlert && (
        <div className="templatesAlert">
          <div className="inner">
            ...
            <button className="saveBtn" onClick={afterEditAlert}>
              Save
            </button>
            <button className="discardBtn" onClick={onClickDiscardBtn}>
              Discard edit
            </button>
          </div>
        </div>
